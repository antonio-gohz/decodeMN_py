function [signal,  decompParameters] = getPulseTrains(eSIG, decompParameters, onlineFlag)
...
if onlineFlag % for offline data
    iReSIGt = decompParameters.iReSIGt;
else % in offline version this should be identity matrix
    iReSIGt = eye(size(decompParameters.dewhitMat));
end
